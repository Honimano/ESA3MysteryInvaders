...
if __name__ == '__main__':
    ...
    button1 = button(position=(450, 300), size=(100, 50), clr=(220, 220, 220), cngclr=(255, 0, 0), func=fn1,
                     text='level 1')
    button2 = button(position=(450,380), size=(100, 50), clr=(150, 150, 150), cngclr= (255,0,0), func = fn2,
                     text='level2')
    button3 = button(position=(450, 460), size=(100, 50), clr=(100, 50, 100), cngclr=(255, 0, 0), func=fn3,
                     text='level3')
    button4 = button(position=(450, 540), size=(100, 50), clr=(200, 150, 20), cngclr=(255, 0, 0), func=fn_exit,
                     text='exit')
