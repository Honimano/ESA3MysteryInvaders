...
from backgrounds import background_wasser
from backgrounds import background_wiese
from backgrounds import background_hoehle
from button import button
from button import text
from sounds import bullet_Sound
from sounds import explosion_Sound
from foes import foe1, foe2, foe3, foe4, foe5
...
# player
playerImg = pygame.image.load('images/heroes/krebsmonster_100.png')
playerX = 420
playerY = 780
playerX_change = 0
...
for i in range(num_of_enemies):
    enemyImg.append(pygame.image.load(foe1))
    enemyImg.append(pygame.image.load(foe2))
    enemyImg.append(pygame.image.load(foe3))
...
bulletImg = pygame.image.load('images/laser/wurfdonat_32.png')
bulletX = 0
bulletY = 780
bulletX_change = 4
bulletY_change = 10
        ...
        if event.type == pygame.KEYDOWN:
            ...
            if event.key == pygame.K_SPACE:
                if bullet_state == "ready":
                   #bullet sound imported from sounds
                    bullet_Sound.play()
